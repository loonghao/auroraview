#!/usr/bin/env python3
"""Manually update extensions.rs to use types module."""
# Read extensions.rs
...
# Build new content:
# 1. Keep lines 0-48 (module doc + imports)
# 2. Add "mod types;\nuse types::*;\n"
# 3. Skip lines 49 to impl_idx-1 (type definitions)
# 4. Keep lines impl_idx to end (impl blocks)
new_lines = lines[0:49]  # Keep lines 0-48
new_lines.append('\nmod types;\nuse types::*;\n')
# Skip lines 49 to impl_idx-1 (type definitions)
# Keep lines impl_idx to end
