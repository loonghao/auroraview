...
**Run:** `python examples/ai_chat_demo.py`
...
**Run:** `python examples/test_cancel_fix.py`
...
**Run:** `python examples/test_dependency_install.py`
...
**Run:** `python examples/test_enhanced_progress.py`
