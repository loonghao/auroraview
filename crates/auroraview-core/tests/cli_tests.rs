...
#[rstest]
fn normalize_url_localhost_no_scheme() {
...
fn normalize_url_valid_cases(#[case] input: &str, #[case] expected: &str) {
...
#[case("://missing-host")]
#[case(":not-a-url")]
fn normalize_url_invalid_cases(#[case] input: &str) {
...
#[case("crates.io")]
#[case("docs.rs")]
fn normalize_url_well_known_domains_no_scheme(#[case] domain: &str) {
...
#[rstest]
fn rewrite_preserves_http_urls() {
...
#[rstest]
fn rewrite_preserves_data_urls() {
...
#[rstest]
fn rewrite_html_without_html_tags() {
...
#[rstest]
fn rewrite_img_with_absolute_url() {
...
#[rstest]
fn rewrite_multiple_same_resources() {
...
#[rstest]
fn rewrite_preserves_html_structure() {
...
#[rstest]
fn normalize_url_ftp_scheme_passthrough() {
...
#[rstest]
fn rewrite_preserves_auroraview_protocol() {
...
#[rstest]
fn rewrite_link_with_multiple_attrs() {
...
#[rstest]
fn rewrite_script_with_integrity() {
...
#[rstest]
fn normalize_url_with_multiple_query_params() {
...
#[rstest]
fn normalize_url_localhost_with_port_produces_valid_url() {
