...
```bash
vx uv run python .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack html-tailwind
```
...
vx uv run python .codebuddy/skills/ui-ux-pro-max/scripts/search.py "layout responsive" --stack html-tailwind
```
